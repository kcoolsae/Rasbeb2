...
public interface SchoolDao {
    ...
    /**
     * Returns the emails of all teachers for schools that have opened an event in the given year for the given language
     */
    List<String> listTeacherEmails(int yearId, String language);
}
